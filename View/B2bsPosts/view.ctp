...
<div id="nc-b2bs-post-view-<?php echo (int)$frameId; ?>"
...
<div class="text-left">
	<!-- 記事タイトル -->
	<h3><?php echo $b2bsPosts['title']; ?></h3>
	<!-- ステータス -->
	<?php echo $this->element('NetCommons.status_label',
						array('status' => $b2bsPosts['status'])); ?>
</div>
	...
	<?php if ((int)$this->viewVars['rolesRoomId'] !== 0 &&
		...
		<div class="btn-group text-left">
			...
			<ul class="dropdown-menu" role="menu">
				<!-- URL:controller:B2bsPostsController action:view -->
				<!--     argument:frameId, postId(記事), pageNumber(コメント一覧ページ番号), sortParams(ソート), visibleRow(表示件数), narrowDown(絞り込み)-->
				<li><a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . $currentVisibleRow . '/' . 5); ?>">
						<?php echo __d('b2bses', 'Display all posts'); ?>
					</a></li>
				<li><a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . $currentVisibleRow . '/' . NetCommonsBlockComponent::STATUS_PUBLISHED); ?>">
						<?php echo __d('b2bses', 'Published'); ?>
					</a></li>
				<li><a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . $currentVisibleRow . '/' . NetCommonsBlockComponent::STATUS_IN_DRAFT); ?>">
						<?php echo __d('net_commons', 'Temporary'); ?>
					</a></li>
				<li><a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . $currentVisibleRow . '/' . NetCommonsBlockComponent::STATUS_APPROVED); ?>">
	...
	<div class="text-left" style="float:right;">
		...
		<div class="btn-group">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<!--     argument:frameId, postId(記事), pageNumber(コメント一覧ページ番号), sortParams(ソート), visibleRow(表示件数), narrowDown(絞り込み)-->
				<li>
					<a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . 1 . '/' . $currentVisibleRow . '/' . $narrowDownParams); ?>">
						<?php echo __d('b2bses', 'Latest post order'); ?>
					</a>
				</li>
				<li>
					<a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . 2 . '/' . $currentVisibleRow . '/' . $narrowDownParams); ?>">
		...
		<div class="btn-group">
			...
			<ul class="dropdown-menu" role="menu">
				...
				<!--     argument:frameId, postId(記事), pageNumber(コメント一覧ページ番号), sortParams(ソート), visibleRow(表示件数), narrowDown(絞り込み)-->
				<li>
					<a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . 1 . '/' . $narrowDownParams); ?>">
						<?php echo '1' . "件"; ?>
					</a>
				</li>
				<li>
					<a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . 5 . '/' . $narrowDownParams); ?>">
						<?php echo '5' . "件"; ?>
					</a>
				</li>
				<li>
					<a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . 10 . '/' . $narrowDownParams); ?>">
						<?php echo '10' . "件"; ?>
					</a>
				</li>
				<li>
					<a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . 20 . '/' . $narrowDownParams); ?>">
						<?php echo '20' . "件"; ?>
					</a>
				</li>
				<li>
					<a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . 50 . '/' . $narrowDownParams); ?>">
						<?php echo '50' . "件"; ?>
					</a>
				</li>
				<li>
					<a href="<?php echo $this->Html->url('/' . $baseUrl . '/' . $frameId . '/' . $b2bsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . 100 . '/' . $narrowDownParams); ?>">
						<?php echo '100' . "件"; ?>
					</a>
				</li>
			</ul>
						...
						<span class="text-left" style="float:left;">
							<?php if ((int)$this->viewVars['rolesRoomId'] !== 0 && (int)$this->viewVars['rolesRoomId'] < 5) : ?>
								...
								<?php echo $this->Form->create('',
										...
										<?php echo $this->Form->button('<span class="glyphicon glyphicon-thumbs-down">' . $b2bsPosts['unlikesNum'] . '</span>',
												array(
													'type' => 'submit',
													'class' => 'btn btn-link',
													'style' => 'padding: 0;',
...
<?php if ($b2bsPosts['status'] !== NetCommonsBlockComponent::STATUS_PUBLISHED) : ?>
	...
	<div class="col-md-offset-1 col-xs-offset-1">
		<hr />
		<?php echo __d('b2bses', 'This posts has not yet been published'); ?>
	</div>
...
<?php else : ?>
		...
		<div class="panel-group col-md-offset-1 col-md-offset-1 col-xs-offset-1 col-sm-13 col-sm-13 col-xs-13">
			<div class="panel panel-default">
				...
				<div class="panel panel-body">
					<!-- 返信元へのリンク -->
					<?php if ($b2bsPosts['id'] !== $comment['parent_id']) : ?>
							...
							<span class="text-left" style="float:right;">
								<?php echo $this->Form->create('',
									array(
										'div' => false,
										'type' => 'post',
										'url' => '/b2bses/b2bsComments/delete/' . $frameId . '/' . $b2bsPosts['id'] . '/' . $comment['id']
									)); ?>
		...
		<div class="text-center">
			<?php echo $this->element('B2bsPosts/pager'); ?>
		</div>
